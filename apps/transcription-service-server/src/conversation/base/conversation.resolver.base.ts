...
import { TranscriptCreateInput } from "../../transcript/base/TranscriptCreateInput";
...
export class ConversationResolverBase {
  ...
  @graphql.ResolveField(() => [Transcript], { name: "transcripts" })
  async findTranscripts(
    @graphql.Parent() parent: Conversation,
    @graphql.Args() args: TranscriptFindManyArgs
  ): Promise<Transcript[]> {
    const results = await this.service.findTranscripts(parent.id, args);
  ...
  async HandleTranscribingConversation(
    @graphql.Args()
    args: TranscriptCreateInput
  ): Promise<Transcript> {
    return this.service.HandleTranscribingConversation(args);
  }
  ...
  async TranscribeConversation(
    ...
    return this.service.TranscribeConversation(args);
  }
}
