...
import { TranscriptListRelationFilter } from "../../transcript/base/TranscriptListRelationFilter";
...
class ConversationWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TranscriptListRelationFilter,
  })
  @ValidateNested()
  @Type(() => TranscriptListRelationFilter)
  @IsOptional()
  @Field(() => TranscriptListRelationFilter, {
    nullable: true,
  })
