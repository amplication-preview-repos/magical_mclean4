...
import { PolishRequestListRelationFilter } from "../../polishRequest/base/PolishRequestListRelationFilter";
import { StringNullableFilter } from "../../util/StringNullableFilter";
import { DateTimeNullableFilter } from "../../util/DateTimeNullableFilter";

@InputType()
class TranscriptWhereInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => PolishRequestListRelationFilter,
  })
  @ValidateNested()
  @Type(() => PolishRequestListRelationFilter)
  @IsOptional()
  @Field(() => PolishRequestListRelationFilter, {
    nullable: true,
  })
...
export { TranscriptWhereInput as TranscriptWhereInput };
