...
class TranscriptUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PolishRequestUpdateManyWithoutTranscriptsInput,
  })
  @ValidateNested()
  @Type(() => PolishRequestUpdateManyWithoutTranscriptsInput)
  @IsOptional()
  @Field(() => PolishRequestUpdateManyWithoutTranscriptsInput, {
    nullable: true,
  })
...
export { TranscriptUpdateInput as TranscriptUpdateInput };
